...
def load_data(messages_filepath, categories_filepath):
    ...
    OUTPUT:
    df - merged dataframe containing both messages and categories
    '''
...
def clean_data(df):
    '''
    Cleans dataframe by splitting categories into separate columns and converting values to binary
    INPUT:
